...
def main():
    ...
    # Re-produce results
    if configs.seed is not None:  #seed设置
    ...
    if configs.gpu_idx is not None:  #gpu 使用gpu将禁用数据并行
...
def main_worker(gpu_idx, configs):
    ...
    # optionally load weight from a checkpoint  加载
    ...
    # optionally resume from a checkpoint  重开
